...
func TestSourceMapGenerator_Empty(t *testing.T) {
	...
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
		SourceRoot:	"/",
		Sources:	[]string{},
...
func TestSourceMapGenerator_AddSource(t *testing.T) {
	...
	sourceMap := gen.RawSourceMap()
	require.Equal(t, int(sourceIndex), 0)
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
		SourceRoot:	"/",
...
func TestSourceMapGenerator_SetSourceContent(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	sourceContent := "foo"
	require.NoError(t, gen.SetSourceContent(sourceIndex, sourceContent))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, int(sourceIndex), 0)
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
...
func TestSourceMapGenerator_SetSourceContent_ForSecondSourceOnly(t *testing.T) {
	...
	require.NoError(t, gen.SetSourceContent(sourceIndex, sourceContent))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, int(sourceIndex), 1)
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
		SourceRoot:	"/",
...
func TestSourceMapGenerator_SetSourceContent_SourceIndexOutOfRange(t *testing.T) {
	t.Parallel()
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	require.EqualError(t, gen.SetSourceContent(-1, ""), "sourceIndex is out of range")
	require.EqualError(t, gen.SetSourceContent(0, ""), "sourceIndex is out of range")
}
...
func TestSourceMapGenerator_AddName(t *testing.T) {
	...
	sourceMap := gen.RawSourceMap()
	require.Equal(t, int(nameIndex), 0)
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
		SourceRoot:	"/",
...
func TestSourceMapGenerator_AddGeneratedMapping(t *testing.T) {
	t.Parallel()
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	require.NoError(t, gen.AddGeneratedMapping(0, 0))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddGeneratedMapping_OnSecondLineOnly(t *testing.T) {
	t.Parallel()
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	require.NoError(t, gen.AddGeneratedMapping(1, 0))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddSourceMapping(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 0))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddSourceMapping_NextGeneratedCharacter(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 0))
	require.NoError(t, gen.AddSourceMapping(0, 1, sourceIndex, 0, 0))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddSourceMapping_NextGeneratedAndSourceCharacter(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 0))
	require.NoError(t, gen.AddSourceMapping(0, 1, sourceIndex, 0, 1))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddSourceMapping_NextGeneratedLine(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 0))
	require.NoError(t, gen.AddSourceMapping(1, 0, sourceIndex, 0, 0))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddSourceMapping_PreviousSourceCharacter(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 1))
	require.NoError(t, gen.AddSourceMapping(0, 1, sourceIndex, 0, 0))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
...
func TestSourceMapGenerator_AddNamedSourceMapping(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	nameIndex := gen.AddName("foo")
	require.NoError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, 0, nameIndex))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddNamedSourceMapping_WithPreviousName(t *testing.T) {
	...
	require.NoError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, 0, nameIndex2))
	require.NoError(t, gen.AddNamedSourceMapping(0, 1, sourceIndex, 0, 0, nameIndex1))
	sourceMap := gen.RawSourceMap()
	require.Equal(t, sourceMap, &RawSourceMap{
		Version:	3,
		File:		"main.js",
...
func TestSourceMapGenerator_AddGeneratedMapping_GeneratedLineCannotBacktrack(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	require.NoError(t, gen.AddGeneratedMapping(1, 0))
	require.EqualError(t, gen.AddGeneratedMapping(0, 0), "generatedLine cannot backtrack")
}
...
func TestSourceMapGenerator_AddGeneratedMapping_GeneratedCharacterCannotBeNegative(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	require.NoError(t, gen.AddGeneratedMapping(0, 0))
	require.EqualError(t, gen.AddGeneratedMapping(0, -1), "generatedCharacter cannot be negative")
}
...
func TestSourceMapGenerator_AddSourceMapping_GeneratedLineCannotBacktrack(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(1, 0, sourceIndex, 0, 0))
	require.EqualError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 0), "generatedLine cannot backtrack")
}
...
func TestSourceMapGenerator_AddSourceMapping_GeneratedCharacterCannotBeNegative(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	require.NoError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, 0))
	require.EqualError(t, gen.AddSourceMapping(0, -1, sourceIndex, 0, 0), "generatedCharacter cannot be negative")
}

func TestSourceMapGenerator_AddSourceMapping_SourceIndexIsOutOfRange(t *testing.T) {
	t.Parallel()
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	require.EqualError(t, gen.AddSourceMapping(0, 0, -1, 0, 0), "sourceIndex is out of range")
	require.EqualError(t, gen.AddSourceMapping(0, 0, 0, 0, 0), "sourceIndex is out of range")
}
...
func TestSourceMapGenerator_AddSourceMapping_SourceLineCannotBeNegative(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	sourceIndex := gen.AddSource("/main.ts")
	require.EqualError(t, gen.AddSourceMapping(0, 0, sourceIndex, -1, 0), "sourceLine cannot be negative")
}
...
func TestSourceMapGenerator_AddSourceMapping_SourceCharacterCannotBeNegative(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	sourceIndex := gen.AddSource("/main.ts")
	require.EqualError(t, gen.AddSourceMapping(0, 0, sourceIndex, 0, -1), "sourceCharacter cannot be negative")
}
...
func TestSourceMapGenerator_AddNamedSourceMapping_GeneratedLineCannotBacktrack(t *testing.T) {
	...
	sourceIndex := gen.AddSource("/main.ts")
	nameIndex := gen.AddName("foo")
	require.NoError(t, gen.AddNamedSourceMapping(1, 0, sourceIndex, 0, 0, nameIndex))
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, 0, nameIndex), "generatedLine cannot backtrack")
}
...
func TestSourceMapGenerator_AddNamedSourceMapping_GeneratedCharacterCannotBeNegative(t *testing.T) {
	...
	nameIndex := gen.AddName("foo")
	require.NoError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, 0, nameIndex))
	require.EqualError(t, gen.AddNamedSourceMapping(0, -1, sourceIndex, 0, 0, nameIndex), "generatedCharacter cannot be negative")
}
...
func TestSourceMapGenerator_AddNamedSourceMapping_SourceIndexIsOutOfRange(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	nameIndex := gen.AddName("foo")
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, -1, 0, 0, nameIndex), "sourceIndex is out of range")
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, 0, 0, 0, nameIndex), "sourceIndex is out of range")
}
...
func TestSourceMapGenerator_AddNamedSourceMapping_SourceLineCannotBeNegative(t *testing.T) {
	...
	nameIndex := gen.AddName("foo")
	sourceIndex := gen.AddSource("/main.ts")
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, -1, 0, nameIndex), "sourceLine cannot be negative")
}
...
func TestSourceMapGenerator_AddNamedSourceMapping_SourceCharacterCannotBeNegative(t *testing.T) {
	...
	nameIndex := gen.AddName("foo")
	sourceIndex := gen.AddSource("/main.ts")
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, -1, nameIndex), "sourceCharacter cannot be negative")
}
...
func TestSourceMapGenerator_AddNamedSourceMapping_NameIndexIsOutOfRange(t *testing.T) {
	...
	gen := NewGenerator("main.js", "/", "/", tspath.ComparePathsOptions{})
	sourceIndex := gen.AddSource("/main.ts")
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, 0, -1), "nameIndex is out of range")
	require.EqualError(t, gen.AddNamedSourceMapping(0, 0, sourceIndex, 0, 0, 0), "nameIndex is out of range")
}
